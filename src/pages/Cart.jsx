...
// 🎨 CLEAN IMPORT: Only Font Awesome
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faTrashCan, faMinus, faPlus, faArrowLeft, faBagShopping } from '@fortawesome/free-solid-svg-icons';
    ...
    if (cartItems.length === 0) {
        return (
            <div className="empty-cart-container">
                <FontAwesomeIcon icon={faBagShopping} className="empty-icon" />
                                ...
                                <div className="item-info">
                                    ...
                                    <div className="item-price-wrapper">
                                        ...
                                        {item.isSale && item.originalPrice && (
                                            <p className="item-original-price" style={{ textDecoration: 'line-through', fontSize: 'clamp(0.75rem, 1vw, 0.85rem)', color: '#999', margin: '2px 0 0 0' }}>
                                ...
                                <div className="item-controls">
                                    ...
                                    {item.quantity >= 5 && (
                                        <div className="max-qty-warning">
                                            Số lượng tối đa cho mỗi sản phẩm là 5
                                        </div>
                                    )}
