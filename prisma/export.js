...
async function main() {
  console.log('⏳ Connecting to database to extract products...');
  ...
  console.log(`📦 Found ${rawProducts.length} products. Generating file...`);
  ...
  console.log('✅ Success! Your data is safely saved in prisma/product_data.js');
}
