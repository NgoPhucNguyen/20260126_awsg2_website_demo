...
-- AddForeignKey
ALTER TABLE "cart" ADD CONSTRAINT "cart_shipping_coupon_id_fkey" FOREIGN KEY ("shipping_coupon_id") REFERENCES "coupon"("id") ON DELETE SET NULL ON UPDATE CASCADE;
