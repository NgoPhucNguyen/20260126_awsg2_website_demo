/*
  ...
  - You are about to drop the column `remaning` on the `coupon_usage` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE "coupon_usage" DROP COLUMN "remaning",
